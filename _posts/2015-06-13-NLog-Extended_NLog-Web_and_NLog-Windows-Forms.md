...
##Update wiki 
The wiki has been updated to make more clear which [Target](https://github.com/nlog/nlog/wiki/Targets) and which [Layout Renderers](https://github.com/nlog/nlog/wiki/Layout-Renderers) are in each package.
