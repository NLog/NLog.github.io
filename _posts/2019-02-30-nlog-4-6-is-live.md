...
Console coloring now also works on VS Code or other console terminals that supports Ansi output.
...
### LoggingConfiguration loaded from appsettings.json
...
This means one can have a NLog-section in the appsettings.json.
